...
@Sheet(value = "Employee Sheet", title = @Title(value="Employee Details", foreground=Color.GREEN))
public class Employee extends User {

	@Column(header = @Header("Department"), order=3)
	private String dept;
	
	@Column(header = @Header(underline=true), data = @Data(background=Color.YELLOW, foreground=Color.RED, bold=true))
